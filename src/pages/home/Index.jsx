...
const Index = () => {
  return (
    <div>
      ...
      <div className="my-12  max-w-6xl mx-auto ">
        <div className="items flex  justify-center flex-wrap">
          <Link
            ...
            className="item flex w-96 flex-col justify-center items-center       text-center py-8 border px-3 hover:bg-gray-200  transition"
          >
            <img
              src={land}
              className="h-20 w-40 mb-3 rounded-xl object-cover"
              alt=""
            />
      ...
      <div>
        <h1 className="text-center text-4xl my-10 font">
          Popular Painting Items
        </h1>
      </div>
      ...
      <div className="about max-w-6xl mx-auto flex flex-wrap mt-16 mb-16">
        ...
        <div className="right md:w-1/2 md:pl-10 px-3">
          ...
          <p className="text-orange-700 text-md my-7 text-xl">
            {" "}
          ...
          <p>
            ...
            world. We hand-pick every single art piece from the many artists and
            make sure that you get exclusive posters in quality print for your
            home or workplace.
          </p>
